...
<head>
  ...
  <link href="https://fonts.googleapis.com/css2?family=Roboto:wght@400;700&display=swap" rel="stylesheet">
   <link href="{{url('public')}}/assets/plugins/@fortawesome/fontawesome-free/css/all.min.css" rel="stylesheet" />
</head>
...
<body>
  ...
  <div class="container-scroller d-flex">
    ...
    <nav class="sidebar sidebar-offcanvas fixed" id="sidebar" style="background-color:#25695c !important">
        ...
        <div class="navbar-menu-wrapper d-flex align-items-center justify-content-end">
          ...
          <ul class="navbar-nav navbar-nav-right">
            ...
            <li class="nav-item dropdown mr-2">
              <a class="nav-link count-indicator dropdown-toggle d-flex align-items-center justify-content-center" href="{{url('logout')}}" onclick="return confirm('Yakin untuk keluar aplikasi?')">
